...
SELECT DRIVERS.DRIVER_ID, AVG(DRIVERS.RATING) AS AVERAGE_RATING 
FROM DRIVERS
JOIN RIDES ON DRIVERS.DRIVER_ID = RIDES.DRIVER_ID
GROUP BY DRIVERS.DRIVER_ID, DRIVERS.RATING
ORDER BY  DRIVERS.DRIVER_ID DESC, AVERAGE_RATING DESC
