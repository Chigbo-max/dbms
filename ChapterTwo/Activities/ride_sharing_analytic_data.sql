...
INSERT INTO Drivers (DRIVER_ID, Name, Rating, Total_Rides) VALUES
(1, 'John Doe', 4.5, 120),
(2, 'Jane Smith', 4.2, 90),
...
INSERT INTO Riders (Rider_ID, Name, City) VALUES
...
INSERT INTO Rides (RIDE_ID, DRIVER_ID, Rider_ID, Fare, Rating, Distance_KM) VALUES
(1, 1, 1, 3000, 4.5, 10),
(2, 2, 2, 2500, 4.2, 8),
(3, 3, 3, 4500, 4.7, 15),
(4, 4, 4, 3500, 4.3, 12),
...
INSERT INTO Payments (PAYMENT_ID, RIDE_ID, Amount, Payment_Method) VALUES
(1, 1, 3000, 'Card'),
(2, 2, 2500, 'Cash'),
(3, 3, 4500, 'Card'),
